...
class TeamsNotificationChannelTest {
    ...
    private TeamsNotificationChannel channel;

    @BeforeEach
    void setUp() {
        channel = new TeamsNotificationChannel(webClientBuilder);
    }

    @Test
    void should_returnTeams_when_getChannelTypeCalled() {
        assertEquals("TEAMS", channel.getChannelType());
    }
    ...
    void should_markAsFailed_when_noWebhookUrl() {
        ...
        assertEquals("No Teams webhook URL configured", notification.getErrorMessage());
    }
    ...
    void should_sendTeamsMessage_when_validWebhookUrl() {
        Notification notification = createNotification();
        NotificationPreference preference = NotificationPreference.builder()
                .userId(UUID.randomUUID())
                .tenantId(UUID.randomUUID())
