...
class JiraCloudAdapterTest {
    ...
    @BeforeEach
    void setUp() {
        adapter = new JiraCloudAdapter(sslHelper);
    }
    ...
    private void configureAdapter() {
        ...
        adapter.configure("https://example.atlassian.net", Map.of("apiToken", "my-token"));
    }
    ...
    void should_getProjects_when_configured() {
                ...
                [
                  {
                    ...
                    "avatarUrls": {
                      "48x48": "https://example.atlassian.net/avatar/proj.png"
                    }
                  },
                  {
                    "key": "DEMO",
        ...
        assertEquals("A test project", projects.get(0).getDescription());
        assertTrue(projects.get(0).getUrl().contains("/browse/PROJ"));
        assertEquals("https://example.atlassian.net/avatar/proj.png", projects.get(0).getAvatarUrl());

        assertEquals("DEMO", projects.get(1).getKey());
        assertEquals("Demo Project", projects.get(1).getName());
